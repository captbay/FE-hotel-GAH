    ...
    <div>
      ...
      <div className="flex flex-col gap-2 mt-4">
        ...
        <ul className="flex flex-col gap-2 text-sm">
          ...
          <li>Hiburan - Televisi LCD dengan channel TV premium channels</li>
          <li>
            Makan Minum - Pembuat kopi/teh, minibar, layanan kamar 24-jam, air
            minum kemasan gratis, termasuk sarapan
          </li>
          <li>
            Untuk tidur - Seprai kualitas premium dan gorden/tirai kedap cahaya
          </li>
          <li>
            Kamar Mandi - Kamar mandi pribadi dengan bathtub dan shower
            terpisah, jubah mandi, dan sandal
          </li>
          <li>
            Kemudahan - Brankas (muat laptop), Meja tulis, dan Telepon; tempat
            tidur lipat/tambahan tersedia berdasarkan permintaan
          </li>
