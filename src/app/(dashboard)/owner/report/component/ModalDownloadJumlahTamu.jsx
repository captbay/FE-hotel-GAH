import { cetakLaporan3 } from '@/api/api';
import React, { useEffect, useState } from 'react'

const ModalDownloadJumlahTamu = ({
  onClose,
  token,
  year
}) => {
  ...
  const _getLaporan2 = async () => {
    ...
    try {
      setIsLoading(true)
      const res = await cetakLaporan3(token, year);
              ...
              <div className="sm:flex sm:items-start ">
                <div className="w-full mt-3 text-center sm:mt-0 sm:text-left">
                  <h3
                    ...
                    id="modal-title"
                  >
                    Cetak Laporan Jumlah Tamu tahun <span className='underline'>{year}</span> ?
                  </h3>
                  ...
                  {laporan2.length != 0 ?
                    ...
                    isLoading ?
                      ...
                      :
                      <p>
                        Apakah anda ingin mencetak laporan jumlah tamu ?
                      </p>
                  }
...
export default ModalDownloadJumlahTamu