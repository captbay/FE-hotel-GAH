import { cetakLaporan1 } from '@/api/api';
import React, { useEffect, useState } from 'react'

const ModalDownloadCustomerBaru = ({
  onClose,
  year,
  token
}) => {
  ...
  const _getLaporan1 = async () => {
    ...
    try {
      const res = await cetakLaporan1(token, year);
              ...
              <div className="sm:flex sm:items-start ">
                <div className="w-full mt-3 text-center sm:mt-0 sm:text-left">
                  <h3
                    ...
                    id="modal-title"
                  >
                    Cetak Laporan Customer Baru tahun <span className='underline'>{year}</span> ?
                  </h3>
                  ...
                  {laporan1.length != 0 ?
                    ...
                    isLoading ?
                      ...
                      :
                      <p>
                        Apakah anda ingin mencetak laporan customer baru ?
                      </p>
                  }
...
export default ModalDownloadCustomerBaru